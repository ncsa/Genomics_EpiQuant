...
[jacobrh@iforgehn3 target]$ spark-submit --master local --driver-java-options "-Dlog4j.configuration=file:/ui/ncsa/jacobrh/Genomics_EpiQuant/SPAEML/conf/log4j.properties" SPAEML-0.0.1-jar-with-dependencies.jar ConvertFormat
